...
MODULE(BH2011BehaviorControl)
  ...
  PROVIDES_WITH_MODIFY(HeadMotionProposal)
...
private:
  ...
  */
  ...
  void update(HeadMotionProposal& headMotionProposal) {headMotionProposal = theBehaviorControlOutput.headMotionProposal;}
